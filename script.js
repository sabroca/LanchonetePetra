...
const products = [
  { id: "combo3", name: "Combo Petra 3", category: "combos", price: "R$ 39,90", description: "X-Frango + Nuggets + Refrigerante lata.", image: "assets/img/combo3.png" },
  ...
  { id: "combo1", name: "Combo Petra 1", category: "combos", price: "R$ 29,90", description: "X-Salada + Batata (P) + Refrigerante lata.", image: "assets/img/combo1.png" },
  { id: "combo2", name: "Combo Petra 2", category: "combos", price: "R$ 34,90", description: "X-Bacon + Batata (M) + Refrigerante lata.", image: "assets/img/combo2.png" },
  { id: "combo3", name: "Combo Petra 3", category: "combos", price: "R$ 39,90", description: "X-Frango + Nuggets + Refrigerante lata.", image: "assets/img/combo3.png" },

  { id: "lanche1", name: "X-Salada", category: "lanches", price: "R$ 18,90", description: "Pão, hambúrguer, queijo, alface e tomate.", image: "assets/img/lanche.png" },
  { id: "lanche2", name: "X-Frango", category: "lanches", price: "R$ 21,90", description: "Frango grelhado, queijo, salada e molho especial.", image: "assets/img/lanche.png" },
  ...
  { id: "lanche4", name: "X-Calabresa", category: "lanches", price: "R$ 23,90", description: "Calabresa acebolada, queijo e vinagrete.", image: "assets/img/lanche.png" },
  { id: "lanche5", name: "X-Egg", category: "lanches", price: "R$ 20,90", description: "Hambúrguer, queijo e ovo na chapa.", image: "assets/img/lanche.png" },
  { id: "lanche6", name: "X-Bacon Duplo", category: "lanches", price: "R$ 28,90", description: "Dois hambúrgueres, bacon, cheddar e molho da casa.", image: "assets/img/lanche.png" },
